...
<head>
    ...
    <title>Wendy Flowers - Admin Website</title>
    <base href="{{asset(' ')}}"/>
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block bg-login-image" style="text-align:center;line-height:35">
                                <img src="admin_asset/assets/dest/img/logowd.png" style="
                                width: 250px;
                                height: 250px;"/>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Chào mừng bạn đến với trang quản trị của Wendy Flowers!</h1>
                                    </div>
